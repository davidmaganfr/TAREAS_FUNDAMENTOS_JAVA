...
public class Console {
    ...
    /**
     * Lee un texto a través de teclado hasta que se pulsa la tecla Intro.
    ...
    /**
     * Lee un número entero a trav&eacute;s de teclado hasta que se pulsa la tecla Intro.
     * @param message Un mensaje que se mostrar&aacute; al principio.
    ...
    /**
     * Lee un n&uacute;mero con decimales a través de teclado hasta que se pulsa
     * la tecla Intro.
     * @param message Un mensaje que se mostrar&aacute; al principio.
